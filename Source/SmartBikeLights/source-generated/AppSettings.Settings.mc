...
module AppSettings {
    ...
    class ControllersMenu extends BaseMenu {
        ...
        public function initialize(view) {
            ...
            for (var i = 0; i < controllers.size(); i++) {
                Menu2.addItem(new WatchUi.MenuItem("Pair " + controllers[i][1] /* Name */, null, i, null));
            }
        }
    ...
    class PairControllerMenu extends BaseMenu {
        ...
        public function initialize(view, controllerIndex) {
            ...
            Menu2.addItem(new WatchUi.MenuItem("Starting...", null, 0, null));
            Menu2.addItem(new WatchUi.MenuItem("Cancel", null, 1, null));
