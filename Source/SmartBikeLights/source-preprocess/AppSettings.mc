...
// #endif
    ...
    class Menu extends BaseMenu {
        ...
        public function initialize() {
            ...
            Menu2.addItem(new /* #include UIMODULE */MenuItem(Rez.Strings.AC, (colorIndex < 0 ? null : Rez.Strings[colorNames[colorIndex]]), 1, null));
            // Current configuration
            var configurationIndex = configurationValues.indexOf((Properties.getValue("CC")));
            Menu2.addItem(new /* #include UIMODULE */MenuItem(Rez.Strings.CC, (configurationIndex < 0 ? null : Rez.Strings[configurationNames[configurationIndex]]), 2, null));
        }
    ...
    class ListMenu extends BaseMenu {
        ...
        public function initialize(title, key, menuItem, values, names) {
            ...
            for (var i = 0; i < values.size(); i++) {
                var value = values[i];
                var name = names[i];
                Menu.addItem(new /* #include UIMODULE */MenuItem(Rez.Strings[name], null, value, null));
            }
        }
